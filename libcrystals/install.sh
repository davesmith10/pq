#!/usr/bin/env bash
# install.sh — build and install libcrystals to a system prefix.
#
# Creates a fat static archive (libcrystals.a) that bundles the Kyber, Dilithium,
...
FAT_ARCHIVE="${WORK_DIR}/libcrystals.a"
...
# Fat static archive
install -m 644 "${FAT_ARCHIVE}" "${PREFIX}/lib/libcrystals.a"
ranlib "${PREFIX}/lib/libcrystals.a"
...
# CrystalsConfig.cmake — generated by libcrystals/install.sh
...
if(NOT TARGET Crystals::crystals)
    ...
    set_target_properties(Crystals::crystals PROPERTIES
        IMPORTED_LOCATION             "\${_crystals_root}/lib/libcrystals.a"
